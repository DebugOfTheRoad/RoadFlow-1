<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebForm.Platform.Members.Default" %>
...
<body style="padding:2px 0; overflow:hidden;">
    ...
    <table cellpadding="0" cellspacing="1" border="0" width="100%">
        <tr>
            <td style="width:250px; vertical-align:top; padding:5px 5px 0 5px;">
