<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddApp.aspx.cs" Inherits="WebForm.Platform.RoleApp.AddApp" %>
...
<body>
    ...
    <div class="buttondiv">
        ...
        <input type="button" value="返回" class="mybutton" onclick="window.location='Body.aspx'+'<%=Request.Url.Query%>';" />
    </div>
    </form>
    <script type="text/javascript">
        ...
        function loadApp(value)
        {
            ...
            $.ajax({ url: "GetApps.ashx", type: "post", data: { "type": value }, dataType: "text", async: false, cache: false, success: function (txt)
            {
                var $appid = $("#AppID");
                $("option", $appid).remove();
