<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Body1.aspx.cs" Inherits="WebForm.Platform.UserApp.Body1" %>
...
<body>
    ...
    <div class="buttondiv">
        <input type="button" value="添加子项" class="mybutton" onclick="window.location='AddApp.aspx?page=Body1.aspx<%=query%>';" />
    ...
    <script type="text/javascript">
        ...
        function loadApp(value)
        {
            ...
            $.ajax({ url: "GetApps.aspx", type: "post", data: { "type": value, "value":"<%=AppID%>" }, dataType: "text", async: false, cache: false, success: function (txt)
            {
                var $appid = $("#AppID");
                $("option", $appid).remove();
