<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebForm.Platform.UserApp.Default" %>
    ...
    <table cellpadding="0" cellspacing="1" border="0" width="100%">
        <tr>
            ...
            <td class="organizesplit">
                <iframe id="Iframe2" frameborder="0" scrolling="auto" src="Empty.aspx<%=query %>" style="width:100%;margin:0;padding:0;"></iframe> 
            </td>
        </tr>
    </table>
    </form>
