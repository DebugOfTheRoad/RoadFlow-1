...
<%
    ...
    string defaultOptions = workFlowFrom.GetDefaultValueSelectByAspx("");
    string dbconnOptions = new RoadFlow.Platform.DBConnection().GetAllOptions();
%>
        ...
        <td colspan="2">
            <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                <tr>
                    ...
                    <td><input type="text" class="mytext" id="text_defaultvalue" style="width:250px; margin-right:6px;"/><select class="myselect" onchange="setDefaultValue(document.getElementById('text_defaultvalue'), this.value);" style="width:100px"><%=workFlowFrom.GetDefaultValueSelectByAspx("") %></select></td>
                </tr>
                <tr>
                    <th>值类型：</th>
    ...
    <tr id="mode_textarea" style="display:none;">
        <td colspan="2">
            <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                <tr>
                    <th style="width:100px;">默认值：</th>
                    <td><input type="text" class="mytext" id="textarea_defaultvalue" style="width:250px; margin-right:6px;"/><select class="myselect" onchange="setDefaultValue(document.getElementById('textarea_defaultvalue'), this.value);" style="width:100px"><%=workFlowFrom.GetDefaultValueSelectByAspx("") %></select></td>
                </tr>
                <tr>
                    <th>值类型：</th>
        ...
        <td colspan="2" style="padding:0; margin:0;">
            ...
            <table cellpadding="0" cellspacing="1" border="0" width="98%" class="formtable" style="margin:0 auto;">
                ...
                <tr>
                    ...
                    <td>
                        <div>数据连接：<select class="myselect" id="select_ds_dbconn"><%=dbconnOptions %></select></div>
                        <div style="margin-top:3px;"><textarea cols="1" rows="1" class="mytextarea"  id="select_ds_sql" style="width:99%; height:60px;"></textarea></div>
                ...
                <tr>
                    ...
                    <td>
                        <div><textarea cols="1" rows="1" class="mytextarea" id="select_ds_string" style="width:99%; height:50px;"></textarea></div>
                        <div>
        ...
        <td colspan="2" style="padding:0; margin:0;">
            ...
            <table cellpadding="0" cellspacing="1" border="0" width="98%" class="formtable" style="margin:0 auto;">
                ...
                <tr>
                    ...
                    <td>
                        <div>数据连接：<select class="myselect" id="checkbox_ds_dbconn"><%=dbconnOptions %></select></div>
                        <div style="margin-top:3px;"><textarea cols="1" rows="1" class="mytextarea"  id="checkbox_ds_sql" style="width:99%; height:60px;"></textarea></div>
                        <div style="margin:3px 0;">格式：SELECT 值字段,标题字段 FROM 表名 WHERE 条件</div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div><textarea cols="1" rows="1" class="mytextarea" id="checkbox_ds_string" style="width:99%; height:50px;"></textarea></div>
                        <div>
                            <div style="margin:3px 0;">格式：值0,标题0;值1,标题1</div>
                            <div>示例：0,事假;1,病假;2,年假;3,婚假</div> 
                        </div>
        ...
        <td colspan="2" style="padding:0; margin:0;">
            ...
            <table cellpadding="0" cellspacing="1" border="0" width="98%" class="formtable" style="margin:0 auto;">
                ...
                <tr>
                    ...
                    <td>
                        <div>数据连接：<select class="myselect" id="radio_ds_dbconn"><%=dbconnOptions %></select></div>
                        <div style="margin-top:3px;"><textarea cols="1" rows="1" class="mytextarea"  id="radio_ds_sql" style="width:99%; height:60px;"></textarea></div>
                        <div style="margin:3px 0;">格式：SELECT 值字段,标题字段 FROM 表名 WHERE 条件</div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <div><textarea cols="1" rows="1" class="mytextarea" id="radio_ds_string" style="width:99%; height:50px;"></textarea></div>
                        <div>
                            <div style="margin:3px 0;">格式：值0,标题0;值1,标题1</div>
                            <div>示例：0,事假;1,病假;2,年假;3,婚假</div> 
                        </div>
    ...
    <tr id="mode_datetime" style="display:none;">
        <td colspan="2">
            <table cellpadding="0" cellspacing="1" border="0" width="100%" class="formtable">
                <tr>
                    <th style="width:100px;">默认值：</th>
                    <td><input type="text" class="mytext" id="datetime_defaultvalue" style="width:250px; margin-right:6px;"/><select class="myselect" onchange="setDefaultValue(document.getElementById('datetime_defaultvalue'), this.value);" style="width:100px"><%=workFlowFrom.GetDefaultValueSelectByAspx("") %></select></td>
                </tr>
...
<script type="text/javascript">
    ...
    $(function ()
    {
        $("#select_ds_dbconn").val(dbconn || "");
        $("#checkbox_ds_dbconn").val(dbconn || "");
        $("#radio_ds_dbconn").val(dbconn || "");
        if (elehidden.size() > 0)
        {
            ...
            if (jsonstr.length > 0)
            {
                ...
                switch (editmode)
                {
                    ...
                    case "select":
                        ...
                        $("#select_ds_dbconn").val(editjson.select_ds_dbconn);
                    ...
                    case "checkbox":
                        ...
                        $("#checkbox_ds_dbconn").val(editjson.checkbox_ds_dbconn);
                    ...
                    case "radio":
                        ...
                        $("#radio_ds_dbconn").val(editjson.radio_ds_dbconn);
    ...
    function select_default()
    {
        ...
        {
            var conn = $("#select_ds_dbconn").val();
            var sql = $("#select_ds_sql").val();
            $.ajax({
                url: "getsqljson.aspx", type: "post", data: { sql: sql, conn: conn }, cache: false, async: false, dataType: "json", success: function (json)
                {
                    for (var i = 0; i < json.length; i++)
                    {
                        var title = json[i].title;
    ...
    function checkbox_default()
    {
        ...
        {
            var conn = $("#checkbox_ds_dbconn").val();
    ...
    function confirm1()
    {
        ...
        switch (mode)
        {
            case "text":
                edittxt = "文本框";
                editjson.text_defaultvalue = encodeURI($("#text_defaultvalue").val());
            ...
            case "textarea":
                edittxt = "文本域";
                editjson.textarea_defaultvalue = encodeURI($("#textarea_defaultvalue").val());
            ...
            case "select":
                ...
                editjson.select_ds_dbconn = $("#select_ds_dbconn").val();
            ...
            case "checkbox":
                ...
                editjson.checkbox_ds_dbconn = $("#checkbox_ds_dbconn").val();
            ...
            case "radio":
                ...
                editjson.radio_ds_dbconn = $("#radio_ds_dbconn").val();
            ...
            case "datetime":
                edittxt = "日期时间";
                editjson.datetime_defaultvalue = encodeURI($("#datetime_defaultvalue").val());
            ...
            case "org":
                edittxt = "组织机构";
                editjson.org_defaultvalue = encodeURI($("#org_defaultvalue").val());
